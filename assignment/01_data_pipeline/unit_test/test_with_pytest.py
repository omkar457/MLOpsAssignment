...
def test_load_data_into_db():
    ...
    """
    output = load_data_into_db()
    assert output != "Error", "loaded_data_test_case"
...
def test_map_city_tier():
    ...
    """
    output = map_city_tier()
    assert output != "Error", "city_tier_mapped_test_case"
...
def test_map_categorical_vars():
    ...
    """
    output = map_categorical_vars()
    assert output != "Error", "categorical_variables_mapped_test_case"
